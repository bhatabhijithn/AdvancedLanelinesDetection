...
class tracker():
    ...
    #the mail tracking function for finding and storing lane segment positions
    def find_window_centroids(self, warped):
        ...
        for level in range(1, (int)(warped.shape[0]/window_height)):
            #convolve the wondow into the vertical slice of the image
        ...
        #return averaged values of the line centers, help to keep the markers from jumping around too much
